...
function js_calendar_open(number){
	...
	var scroll;
	// создаем календарь указываем год и месяц (отсчет месяца с 0)
	createCalendar("calendar-body__fild", 2014, 2);
	...
	document.getElementById('calendar-body__month').innerHTML = 'Март';
